...
namespace TaskManager
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            const string version = "v0.4.1729 alpha";//строка версии (смотри правила оформления ниже) 
   ...
   ВАЖНО!!! 1) Писать свой код ТОЛЬКО в функции Main(), находящейся в TaskM.cs, так как она отвечает за дальнейшую обработку программы
            ...
            6) При использовании Get-функций не забывайте, что полученная структура является независимой от датабазы единицей, поэтому её следует интегрировать в датабазу после работы с ней
            7) Форму Logger трогать категорически запрещено (убрать её можно лишь вручную закрыв или поставив значение isDebug на false)
            8) Работать с Database.Date(string date) с осторожностью:
